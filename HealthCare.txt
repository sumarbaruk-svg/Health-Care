...
with st.container(border=True):
    ...
    # 7. CONTACT SECTION (Final Fix)
with st.container(border=True):
    st.title("Contact Us")
    st.markdown("### 📍 PEARL PharmMed Healthcare Consulting Pvt. Ltd.")
    st.markdown("### 📞 Get in Touch")

    # கீழே உள்ள html_code என்ற variable-ஐ மாற்ற வேண்டாம்
    contact_html = """
<div style="font-weight: 500; font-size: 1.15rem; line-height: 2.2; color: #000000;">
    ...
    📧 <b>Email:</b> 
    <a href="mailto:info@ppti.in" style="text-decoration: none; color: #007bff;">info@ppti.in</a>
    <br>
    🌐 <b>Website:</b> 
...
"""
    # அந்த variable-ஐ இங்கே பயன்படுத்துகிறோம்
